...
如果你现在继续学，不要再按根目录旧课文件线性往下看，而是按下面顺序进入：
...
7. `Sprint1-Lesson7：Session 初版`
8. `Sprint1-Lesson8：最小测试`
9. `Sprint1-Lesson9：错误处理初版`
10. `Sprint1-Lesson10：Sprint 1 重构课`
...
- 旧课不删除，但全部降级为参考材料。
- Sprint 是现在唯一主线。
- 后续新增课程默认放进 `../阶段3-Sprint1/`。
- 只有 Sprint 1 完整闭环后，才进入工程化阶段。